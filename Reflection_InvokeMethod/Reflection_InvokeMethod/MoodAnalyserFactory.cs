...
namespace Reflection_InvokeMethod
{
    public class MoodAnalyserFactory
    {
        ...
        public static string InvokeAnalyseMood(string message, string methodName)
        {
            try
            {
                Type type = Type.GetType("Reflection_InvokeMethod.MoodAnalyser");
                object moodAnalyserObject = MoodAnalyserFactory.CreateMoodAnalyserUsingParameterizedConstructor("Reflection_InvokeMethod.MoodAnalyser", "MoodAnalyser", message);
