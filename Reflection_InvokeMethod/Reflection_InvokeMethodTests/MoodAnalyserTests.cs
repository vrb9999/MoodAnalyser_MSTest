...
using Reflection_InvokeMethod;
using System;
using System.Collections.Generic;
using System.Text;

namespace Reflection_InvokeMethod.Tests
{
    [TestClass()]
    public class MoodAnalyserTests
    {
        ...
        public void GivenMoodAnalyseClassName_ShouldReturnMoodAnalyserObject()
        {
            ...
            object obj = MoodAnalyserFactory.CreateMoodAnalyse("Reflection_InvokeMethod.MoodAnalyser", "MoodAnalyser");
            expected.Equals(obj);
        }
        [TestMethod]
        public void GivenMoodAnalyseClassName_ShouldReturnMoodAnalyserObject_UsingParameterizdConstructor()
        {
            ...
            object obj = MoodAnalyserFactory.CreateMoodAnalyserUsingParameterizedConstructor("Reflection_InvokeMethod.MoodAnalyser", "MoodAnalyser", "HAPPY");
            expected.Equals(obj);
        }
        [TestMethod]
